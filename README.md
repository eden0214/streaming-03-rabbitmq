...
1. Imports should be one per line - why?  To simplify code and make them easy to identify.
1. Then, define your functions.
1. Functions are reusable logic blocks.
1. Everything the function needs comes in through the arguments.
1. A function may - or may not - return a value. 
1. When we open a connection, we should close the connection. 
1. Which of the 4 files will always close() the connection?  Emit messages close the connection.
1. Search GitHub for if __name__ == "__main__":
1. How many hits did you get? Over 24M in code
1. Learn and understand this common Python idiom. Working on it.
